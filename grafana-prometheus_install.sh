...
kubectl apply -f /home/vagrant/RafK8clstr/Grafana-prometheus/grafana-pv-pvc.yml
kubectl apply -f //home/vagrant/RafK8clstr/Grafana-prometheus/prometheus-pv-pvc.yml
